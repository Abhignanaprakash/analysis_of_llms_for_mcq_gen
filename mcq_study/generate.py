...
def one_model(name,cfg):
    ...
    with open(dest/f"{name}.csv","w",newline="",encoding="utf-8") as out:
        fields=["id","model","context","reference_question","reference_options","reference_answer","generated","response_time_s","peak_gpu_memory_mb","generated_tokens","tokens_per_second"]
